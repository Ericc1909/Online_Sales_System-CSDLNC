...
namespace QL_DatHang_GiaoHang
{
    public partial class form_DH_KH : Form
    {
        ...
        private void refresh_dataGridView1()
        {
            ...
            string query = "select * from DONDATHANG where MA_KHACH_HANG = '" + MaKH + "' and TINH_TRANG= N'đã giao'";
        ...
        {
            MaDonCanXem= dataGridView3.SelectedRows[1].Cells[0].Value.ToString();
           form_CHITIETDONHANG f = new form_CHITIETDONHANG(MaDonCanXem);
            f.Show();
        }
    }
}
