...
namespace QL_DatHang_GiaoHang
{
    public partial class form_DDN_TX : Form
    {
        ...
        {
            string tinhtrang = textBox3.Text;
            string sql = "update DONDATHANG set TINH_TRANG = @tinhtrang where MA_TAI_XE = @matx_ddn ";
            Dataprovider.Instance.ExecuteQuery(sql, new object[] { tinhtrang, matx_ddn });
