...
namespace QL_DatHang_GiaoHang
{
    public partial class form_DSDon_TX : Form
    {
        ...
        DataSet GetDSDon()
        {
            ...
            string query2 = "select TOP 2000 MA_DON, MA_KHACH_HANG, DIA_CHI, TINH_TRANG, TONG_TIEN from DONDATHANG where TINH_TRANG=N'chờ xác nhận' order by MA_DON ";
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            string MaDon = row.Cells[0].Value.ToString();
            textBox1.Text = MaDon;
        }
    }
}
